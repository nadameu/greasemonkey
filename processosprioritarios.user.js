...
var LocalizadoresProcessoFactory = class {
	static fromCelula(celula, numprocFormatado) {
...
var infoMeta = {
	...
	'721495116809325210234371222906': {
		BAIXADO: {
			campoDataConsiderada: 'dataInclusaoLocalizador',
			dias: {
				[CompetenciasCorregedoria.JUIZADO]: 300,
...
var ProcessoFactory = class {
	static fromLinha(linha) {
		...
		const localizadores = LocalizadoresProcessoFactory.fromCelula(linha.cells[7], numprocFormatado);
