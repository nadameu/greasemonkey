...
class GUI {
    ...
    criarGrafico(localizadores) {
        ...
        (_a = info[0]) === null || _a === void 0 ? void 0 : _a.linha.parentNode.append(...info.map(({ linha }) => linha));
...
class LocalizadorProcessoFactory {
    static fromInput(input) {
        ...
        if (linkLembrete === null || linkLembrete === void 0 ? void 0 : linkLembrete.attributes.hasOwnProperty('onmouseover')) {
            ...
            lembrete = (_f = (_e = onmouseover.match(/^return infraTooltipMostrar\('Obs: (.*) \/ ([^(]+)\(([^)]+)\)','',400\);$/)) === null || _e === void 0 ? void 0 : _e[1]) !== null && _f !== void 0 ? _f : undefined;
        }
...
function calcularRecessoData(data) {
...
function calcularAtraso(a, b) {
    ...
    return (Math.max(0, inicio.getTime() - a.getTime()) -
        Math.max(0, inicio.getTime() - b.getTime()) +
        Math.max(0, b.getTime() - retorno.getTime()));
}
class Processo {
    constructor({ classe, dadosComplementares, dataAutuacao, dataInclusaoLocalizador, dataSituacao, dataUltimoEvento, juizo, lembretes, linha, link, localizadores, numClasse, numCompetencia, numproc, numprocFormatado, sigilo, situacao, ultimoEvento, }) {
        this.classe = classe;
    ...
    get termoPrazoCorregedoria() {
        ...
        while (dataTermo >= recesso.inicio) {
            dataTermo.setTime(dataTermo.getTime() + (recesso.retorno.getTime() - recesso.inicio.getTime()));
