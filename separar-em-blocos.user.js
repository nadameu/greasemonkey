...
function isArray(predicate) {
  return refine((value) => Array.isArray(value), (xs) => xs.every(predicate));
}
...
function hasShape(predicates) {
  ...
  return refine(hasKeys(...required), (obj) => required.every((key) => predicates[key](obj[key])) && optional.every((key) => key in obj ? predicates[key](obj[key]) : true));
}
function isTaggedUnion(tagName, union) {
  return isAnyOf(...Object.entries(union).map(([tag, extraProperties]) => refine(hasShape({ [tagName]: isLiteral(tag) }), hasShape(extraProperties))));
}
...
function w(n2, l3, u3, i3, t3, r3, o3, f3, s2, a3) {
  var h3, v3, p7, _2, b3, m3, g3, w3 = i3 && i3.__k || c, A2 = w3.length;
  for (u3.__k = [], h3 = 0; h3 < l3.length; h3++)
    if ((_2 = u3.__k[h3] = (_2 = l3[h3]) == null || typeof _2 == "boolean" ? null : typeof _2 == "string" || typeof _2 == "number" || typeof _2 == "bigint" ? y(null, _2, null, null, _2) : Array.isArray(_2) ? y(d, { children: _2 }, null, null, null) : _2.__b > 0 ? y(_2.type, _2.props, _2.key, null, _2.__v) : _2) != null) {
      if (_2.__ = u3, _2.__b = u3.__b + 1, (p7 = w3[h3]) === null || p7 && _2.key == p7.key && _2.type === p7.type)
        w3[h3] = void 0;
      else
        for (v3 = 0; v3 < A2; v3++) {
      ...
      j(n2, _2, p7 = p7 || e, t3, r3, o3, f3, s2, a3), b3 = _2.__e, (v3 = _2.ref) && p7.ref != v3 && (g3 || (g3 = []), p7.ref && g3.push(p7.ref, null, _2), g3.push(v3, _2.__c || b3, _2)), b3 != null ? (m3 == null && (m3 = b3), typeof _2.type == "function" && _2.__k === p7.__k ? _2.__d = s2 = x(_2, s2, n2) : s2 = P(n2, _2, p7, w3, b3, s2), typeof u3.type == "function" && (u3.__d = s2)) : s2 && p7.__e == s2 && s2.parentNode != n2 && (s2 = k(p7));
    }
...
function j(n2, u3, i3, t3, r3, o3, f3, e3, c3) {
  var s2, h3, v3, y3, p7, k3, b3, m3, g3, x3, A2, P2 = u3.type;
  ...
  try {
    n:
      if (typeof P2 == "function") {
        if (m3 = u3.props, g3 = (s2 = P2.contextType) && t3[s2.__c], x3 = s2 ? g3 ? g3.props.value : s2.__ : t3, i3.__c ? b3 = (h3 = u3.__c = i3.__c).__ = h3.__E : ("prototype" in P2 && P2.prototype.render ? u3.__c = h3 = new P2(m3, x3) : (u3.__c = h3 = new _(m3, x3), h3.constructor = P2, h3.render = O), g3 && g3.sub(h3), h3.props = m3, h3.state || (h3.state = {}), h3.context = x3, h3.__n = t3, v3 = h3.__d = true, h3.__h = []), h3.__s == null && (h3.__s = h3.state), P2.getDerivedStateFromProps != null && (h3.__s == h3.state && (h3.__s = a({}, h3.__s)), a(h3.__s, P2.getDerivedStateFromProps(m3, h3.__s))), y3 = h3.props, p7 = h3.state, v3)
...
function L(l3, u3, i3, t3, r3, o3, f3, c3) {
  var s2, a3, v3, y3 = i3.props, p7 = u3.props, d2 = u3.type, _2 = 0;
  ...
  if (l3 == null) {
    ...
    l3 = r3 ? document.createElementNS("http://www.w3.org/2000/svg", d2) : document.createElement(d2, p7.is && p7), o3 = null, c3 = false;
  }
  if (d2 === null)
    y3 === p7 || c3 && l3.data === p7 || (l3.data = p7);
  else {
    if (o3 = o3 && n.call(l3.childNodes), a3 = (y3 = i3.props || e).dangerouslySetInnerHTML, v3 = p7.dangerouslySetInnerHTML, !c3) {
      if (o3 != null)
        for (y3 = {}, _2 = 0; _2 < l3.attributes.length; _2++)
          y3[l3.attributes[_2].name] = l3.attributes[_2].value;
      (v3 || a3) && (v3 && (a3 && v3.__html == a3.__html || v3.__html === l3.innerHTML) || (l3.innerHTML = v3 && v3.__html || ""));
    }
    if (C(l3, p7, y3, r3, c3), v3)
      u3.__k = [];
      ...
      for (_2 = o3.length; _2--; )
        o3[_2] != null && h(o3[_2]);
    c3 || ("value" in p7 && (_2 = p7.value) !== void 0 && (_2 !== l3.value || d2 === "progress" && !_2) && H(l3, "value", _2, y3.value, false), "checked" in p7 && (_2 = p7.checked) !== void 0 && _2 !== l3.checked && H(l3, "checked", _2, y3.checked, false));
  }
  return l3;
}
function M(n2, u3, i3) {
...
function createBroadcastService({ debug = false } = {}) {
  ...
  function listener(evt) {
    ...
    if (isBroadcastMessage(evt.data))
...
function promisify(eventName) {
  return (obj) => new Promise((res, rej) => {
...
var compararBlocos = /* @__PURE__ */ compareUsing((bloco) => bloco.nome, alt(compareUsing((x3) => x3.toLowerCase()), compareDefault, (nome) => {
...
async function deleteBloco(id) {
  const [done, blocos] = await makeTransaction("readwrite", (store) => [store.delete(id), store.getAll()]);
  return validarBlocos(blocos);
}
var updateBloco = /* @__PURE__ */ writeBloco("put");
function writeBloco(method) {
  return async (bloco) => {
    const [id, blocos] = await makeTransaction("readwrite", (store) => [store[method](bloco), store.getAll()]);
    assert(isIdBloco(id));
    return validarBlocos(blocos);
  };
}
...
var fromThunk = createFromAsyncThunk((state) => state, (error) => () => ({ status: "error", error }));
var actions = {
  ...
  blocosObtidos: (blocos) => (state, _2, { mapa }) => {
  ...
  criarBloco: (nome) => fromThunk(async (state, { DB }) => {
  ...
  excluirBD: () => fromThunk(async ({}, { DB }) => {
    await DB.deleteBlocos();
    return actions.obterBlocos();
  }),
  excluirBloco: (bloco) => fromThunk(async ({}, { DB }) => {
  ...
  obterBlocos: () => fromThunk(async ({}, { DB }) => actions.blocosModificados(await DB.getBlocos())),
  noop: () => (state) => state,
  removerProcessosAusentes: (id) => fromThunk(async (_2, { DB, mapa }) => {
    const bloco = await DB.getBloco(id);
    if (!bloco)
      throw new Error(`Bloco n\xE3o encontrado: ${id}.`);
  ...
  renomearBloco: (id, nome) => fromThunk(async ({}, { DB }) => {
    const blocos = await DB.getBlocos();
  ...
  selecionarProcessos: (id) => fromThunk(async ({}, { DB, mapa }) => {
    const bloco = await DB.getBloco(id);
    if (!bloco)
      throw new Error(`Bloco n\xE3o encontrado: ${id}.`);
...
function LocalizadorProcessoLista() {
  ...
  if (linhas.length <= 1)
    return;
  const mapa = new Map(linhas.slice(1).map((linha, i3) => {
...
function Main(props) {
  const extra = A(() => {
    const DB = database_exports, bc = createBroadcastService(), { mapa } = props;
    return { DB, bc, mapa };
  }, []);
  const [state, dispatch] = p2((state2, action) => action(state2, dispatch, extra), { status: "init" });
  h2(() => {
...
function ShowError({ dispatch, reason }) {
  const message = reason instanceof Error ? reason.message ? `Ocorreu um erro: ${reason.message}` : "Ocorreu um erro desconhecido." : `Ocorreu um erro: ${String(reason)}`;
  return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("span", {
    style: "color:red; font-weight: bold;"
  }, message), /* @__PURE__ */ v("br", null), /* @__PURE__ */ v("br", null), /* @__PURE__ */ v("button", {
    onClick: () => dispatch(actions.obterBlocos())
  }, "Tentar carregar dados salvos"), /* @__PURE__ */ v("button", {
...
function Blocos(props) {
  ...
  if (props.state.aviso) {
    aviso = /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("span", {
      style: "color:red"
    }, props.state.aviso), /* @__PURE__ */ v("button", {
      onClick: () => props.dispatch(actions.obterBlocos())
    }, "Recarregar dados"));
  }
  return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("h1", null, "Blocos"), /* @__PURE__ */ v("ul", null, props.state.blocos.map((bloco) => /* @__PURE__ */ v(Bloco2, {
    key: bloco.id,
    ...bloco,
  ...
  }), " ", /* @__PURE__ */ v("button", null, "Criar")), /* @__PURE__ */ v("br", null), aviso);
}
function Bloco2(props) {
  ...
  let botaoRenomear = /* @__PURE__ */ v("button", {
    onClick: onRenomearClicked
  }, "Renomear");
  let removerAusentes = /* @__PURE__ */ v("button", {
  ...
  return /* @__PURE__ */ v("li", null, displayNome, " (", createAbbr(props.nestaPagina, props.total), ") ", botaoRenomear, " ", /* @__PURE__ */ v("button", {
    onClick: onExcluirClicked
  }, "Excluir"), " ", removerAusentes);
  ...
  function onExcluirClicked() {
    ...
    if (len > 0)
      confirmed = window.confirm(`Este bloco possui ${len} processo${len > 1 ? "s" : ""}. Deseja exclu\xED-lo?`);
    if (confirmed)
      props.dispatch(actions.excluirBloco(props.id));
  }
...
var actions2 = {
  ...
  criarBloco: (nome) => fromThunk2(async ({}, { DB }) => {
    const blocos = await DB.getBlocos();
    if (blocos.some((x3) => x3.nome === nome))
  ...
  inserir: (id, { fecharJanela = false } = {}) => actions2.modificarProcessos(id, (processos, numproc) => {
  ...
  modificarProcessos: (id, fn, { fecharJanela = false } = {}) => fromThunk2(async (_2, { DB, numproc }) => {
    const bloco = await DB.getBloco(id);
    if (!bloco)
      throw new Error(`Bloco n\xE3o encontrado: ${id}.`);
  ...
  noop: () => (state) => state,
  obterBlocos: () => fromThunk2(async ({}, { DB }) => actions2.blocosModificados(await DB.getBlocos())),
  remover: (id) => actions2.modificarProcessos(id, (processos, numproc) => {
...
function Main2(props) {
  const extra = A(() => {
    const DB = database_exports, bc = createBroadcastService(), { numproc } = props;
    return { DB, bc, numproc };
  }, []);
  const [state, dispatch] = p2((state2, action) => action(state2, dispatch, extra), { status: "Loading" });
  h2(() => {
...
function ShowError2({ dispatch, reason }) {
  const message = typeof reason === "object" && reason !== null && reason instanceof Error ? reason.message ? `Ocorreu um erro: ${reason.message}` : "Ocorreu um erro desconhecido." : `Ocorreu um erro: ${String(reason)}`;
  return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("h4", null, "Blocos"), /* @__PURE__ */ v("div", {
    class: "error"
  }, message), /* @__PURE__ */ v("button", {
    type: "button",
    onClick: () => dispatch(actions2.obterBlocos())
  }, "Recarregar"));
}
function Placeholder() {
  const li = /* @__PURE__ */ v("li", {
    class: "placeholder"
  }, /* @__PURE__ */ v("span", null), /* @__PURE__ */ v("span", null), /* @__PURE__ */ v("span", null));
  return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("h4", null, "Blocos"), /* @__PURE__ */ v("ul", null, li, li, li), /* @__PURE__ */ v("button", {
    type: "button",
    id: "gm-novo-bloco",
    disabled: true
  }, "Novo"));
...
function Blocos2(props) {
  let aviso = null;
  if (props.erro) {
    aviso = /* @__PURE__ */ v("div", {
      class: "error"
    }, props.erro);
  }
  return /* @__PURE__ */ v(d, null, /* @__PURE__ */ v("h4", null, "Blocos"), /* @__PURE__ */ v("ul", null, props.blocos.map((info) => /* @__PURE__ */ v(Bloco3, {
    key: info.id,
    ...info,
    dispatch: props.dispatch,
...
function Bloco3(props) {
  ...
  return /* @__PURE__ */ v("li", null, /* @__PURE__ */ v("input", {
  ...
  }, props.nome), props.inserido ? /* @__PURE__ */ v("span", null) : /* @__PURE__ */ v(d, null, " ", /* @__PURE__ */ v("input", {
    type: "image",
...
async function main() {
  ...
  switch (acao) {
    ...
    case "processo_selecionar": {
      ...
      assert(isNumProc(numproc), `N\xE3o foi poss\xEDvel analisar o n\xFAmero do proceso: ${JSON.stringify(numproc)}.`);
