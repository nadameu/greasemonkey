...
pesquisaRapida.css('padding-right', '17px');

const icone = $('<a href="#"><img tabindex="52" src="' + urlIcone + '" width="14" height="14" style="position: absolute; margin-top: 4px; margin-left: -17px;" title="Abrir pesquisa em nova janela"/></a>');
icone.on('click', evt => {
  evt.preventDefault();
  evt.stopPropagation();
